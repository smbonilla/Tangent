...
- Keeps multiple recordings per day as separate cards, ordered by recording start time. Use the circled plus in Diary to open a calendar and tap today or any past date to add a recording; details show the recording's start time.
